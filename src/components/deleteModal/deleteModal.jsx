                ...
                <div className=" card ">
                   <div className="card-header bg-default border-default">
                    ...
                    <div className="card-footer bg-default border-default" style={{textAlign:"center"}}>
                        <button id='no' className='btn btn-outline-primary' onClick={hideModal}>Non</button>&nbsp;
                        <button id='yes' className='btn btn-outline-danger' onClick={handleClick} >Oui</button>
                    </div>
                </div>
            </div>
        </div>
